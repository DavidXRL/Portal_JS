...
<header class="w-full bg-white shadow-md py-4 px-4 md:px-8 flex items-center justify-between flex-wrap" style="position: sticky; top: 0; z-index: 100;">
    ...
    <nav id="nav-menu" class="w-full md:w-auto space-y-2 md:space-y-0 md:space-x-6 mt-4 md:mt-0 hidden md:block">
        <a href="{{ url('/') }}" class="block md:inline text-gray-900 text-sm md:text-base transition hover:text-gray-500 font-semibold">Volver al inicio</a>
        <a href="{{ route('activities.index') }}" class="block md:inline text-gray-900 text-sm md:text-base transition hover:text-gray-500 font-semibold">Actividades</a>
        <a href="{{ route('comments.index') }}" class="block md:inline text-gray-900 text-sm md:text-base transition hover:text-gray-500 font-semibold">Comentarios</a>
        <a href="{{ route('workshops.index') }}" class="block md:inline text-gray-900 text-sm md:text-base transition hover:text-gray-500 font-semibold">Talleres</a>
